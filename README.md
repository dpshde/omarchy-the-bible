...
- Click-drag verses, or hold Shift while using the arrow keys, to select a range. Space drops the current range and selects only the hovered verse; Shift+Space extends the range upward.
